...
class Andares extends StatefulWidget {
  ...
  @override
  State<Andares> createState() => _AndaresState();
}

class _AndaresState extends State<Andares> {
  ...
  void initState() {
    ...
    //currentSongIndex = playlist.indexWhere((s) => s.music == music);
 ...
 Future<void> nextSong() async {
  //int currentIndex = playlist.indexWhere((song) => song.music == widget.music);
